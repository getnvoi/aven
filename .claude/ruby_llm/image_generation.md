# Image Generation | RubyLLM

Generate images from text descriptions using AI models like DALL-E 3 and Imagen

## [](#table-of-contents)Table of contents

1.  [Basic Image Generation](#basic-image-generation)
2.  [Choosing Models](#choosing-models)
3.  [Image Sizes](#image-sizes)
4.  [Working with Generated Images](#working-with-generated-images)
    1.  [Accessing Image Data](#accessing-image-data)
    2.  [Saving Images Locally](#saving-images-locally)
    3.  [Getting Raw Image Blob](#getting-raw-image-blob)
    4.  [Rails Active Storage Integration](#rails-active-storage-integration)
5.  [Prompt Engineering for Images](#prompt-engineering-for-images)
6.  [Error Handling](#error-handling)
7.  [Content Safety](#content-safety)
...
Refer to the [Working with Models Guide](https://rubyllm.com/models/) and the [Available Models Guide](https://rubyllm.com/available-models/) to find image models.
...
### [](#getting-raw-image-blob)Getting Raw Image Blob
...
### [](#rails-active-storage-integration)Rails Active Storage Integration
...
## [](#prompt-engineering-for-images)Prompt Engineering for Images
...
See the [Error Handling Guide](https://rubyllm.com/error-handling/) for comprehensive error handling strategies.
...
- **Timeouts:** Configure appropriate network timeouts in RubyLLM (see [Configuration Guide](https://rubyllm.com/configuration/)).
...
- [Chatting with AI Models](https://rubyllm.com/chat/): Learn about conversational AI.
- [Embeddings](https://rubyllm.com/embeddings/): Explore text vector representations.
- [Error Handling](https://rubyllm.com/error-handling/): Master handling API errors.
