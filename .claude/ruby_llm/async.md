...
Handle hundreds of concurrent AI requests on modest hardware. Ruby’s async ecosystem meets AI.

## [](#table-of-contents)Table of contents

1.  [Why Async for LLMs?](#why-async-for-llms)
2.  [How RubyLLM Works with Async](#how-rubyllm-works-with-async)
3.  [Concurrent Operations](#concurrent-operations)
    1.  [Multiple Chat Requests](#multiple-chat-requests)
    2.  [Batch Embeddings](#batch-embeddings)
    3.  [Parallel Analysis](#parallel-analysis)
4.  [Background Processing with `Async::Job`](#background-processing-with-asyncjob)
    1.  [Setup with Falcon (Recommended)](#setup-with-falcon-recommended)
    2.  [Note on Puma](#note-on-puma)
    3.  [Your Jobs Work Unchanged](#your-jobs-work-unchanged)
    4.  [Mixing Job Adapters: Best of Both Worlds](#mixing-job-adapters-best-of-both-worlds)
5.  [Rate Limiting with Semaphores](#rate-limiting-with-semaphores)
6.  [Summary](#summary)
...
## [](#why-async-for-llms)Why Async for LLMs?
...
## [](#how-rubyllm-works-with-async)How RubyLLM Works with Async
...
### [](#multiple-chat-requests)Multiple Chat Requests
...
## [](#background-processing-with-asyncjob)Background Processing with `Async::Job`
...
### [](#setup-with-falcon-recommended)Setup with Falcon (Recommended)
...
### [](#your-jobs-work-unchanged)Your Jobs Work Unchanged
...
### [](#mixing-job-adapters-best-of-both-worlds)Mixing Job Adapters: Best of Both Worlds
...
## [](#rate-limiting-with-semaphores)Rate Limiting with Semaphores
