...
1.  [Understanding the Persistence Flow](#understanding-the-persistence-flow)
    1.  [How It Works](#how-it-works)
    2.  [Why This Design?](#why-this-design)
    3.  [Content Validation Implications](#content-validation-implications)
2.  [Setting Up Your Rails Application](#setting-up-your-rails-application)
    1.  [Quick Setup with Generator](#quick-setup-with-generator)
    2.  [Adding a Chat UI](#adding-a-chat-ui)
        1.  [Generator Options](#generator-options)
    3.  [Setting Up ActiveStorage](#setting-up-activestorage)
    4.  [Configuring RubyLLM](#configuring-rubyllm)
    5.  [Setting Up Models with `acts_as` Helpers](#setting-up-models-with-acts_as-helpers)
        1.  [With Model Registry (Default for new apps)](#with-model-registry-default-for-new-apps)
        2.  [Legacy Mode (Without Model Registry)](#legacy-mode-without-model-registry)
    6.  [Provider Overrides](#provider-overrides)
    7.  [Custom Contexts and Dynamic Models](#custom-contexts-and-dynamic-models)
        1.  [Using Custom Contexts](#using-custom-contexts)
        2.  [Dynamic Model Creation](#dynamic-model-creation)
3.  [Working with Chats](#working-with-chats)
    1.  [Basic Chat Operations](#basic-chat-operations)
    2.  [Database Model Registry](#database-model-registry)
...
4.  [Advanced Topics](#advanced-topics)
    1.  [Handling Edge Cases](#handling-edge-cases)
        1.  [Automatic Cleanup](#automatic-cleanup)
        2.  [Provider Content Restrictions](#provider-content-restrictions)
    2.  [Customizing the Persistence Flow](#customizing-the-persistence-flow)
5.  [Streaming Responses with Hotwire/Turbo](#streaming-responses-with-hotwireturbo)
    1.  [Instant User Messages](#instant-user-messages)
    2.  [Full Streaming Implementation](#full-streaming-implementation)
    3.  [Message Ordering Issues](#message-ordering-issues)
        1.  [Solution 1: Client-Side Reordering (Recommended)](#solution-1-client-side-reordering-recommended)
        2.  [Solution 2: Server-Side Ordering](#solution-2-server-side-ordering)
        3.  [Why This Happens](#why-this-happens)
6.  [Customizing Models](#customizing-models)
    1.  [Using Custom Model Names](#using-custom-model-names)
        1.  [With Model Registry](#with-model-registry)
        2.  [Namespaced Models Example](#namespaced-models-example)
        3.  [Legacy Mode](#legacy-mode)
...
## [](#understanding-the-persistence-flow)Understanding the Persistence Flow
...
### [](#content-validation-implications)Content Validation Implications
...
## [](#setting-up-your-rails-application)Setting Up Your Rails Application

### [](#quick-setup-with-generator)Quick Setup with Generator
...
### [](#adding-a-chat-ui)Adding a Chat UI
...
### [](#setting-up-activestorage)Setting Up ActiveStorage
...
### [](#configuring-rubyllm)Configuring RubyLLM
...
### [](#setting-up-models-with-acts_as-helpers)Setting Up Models with `acts_as` Helpers
...
#### [](#with-model-registry-default-for-new-apps)With Model Registry (Default for new apps)
...
#### [](#legacy-mode-without-model-registry)Legacy Mode (Without Model Registry)
...
### [](#custom-contexts-and-dynamic-models)Custom Contexts and Dynamic Models

Available in v1.7.0+

#### [](#using-custom-contexts)Using Custom Contexts
...
### [](#basic-chat-operations)Basic Chat Operations
...
### [](#database-model-registry)Database Model Registry
...
#### [](#provider-content-restrictions)Provider Content Restrictions
...
### [](#customizing-the-persistence-flow)Customizing the Persistence Flow
...
## [](#streaming-responses-with-hotwireturbo)Streaming Responses with Hotwire/Turbo

The default persistence flow is designed to work seamlessly with streaming and Turbo Streams for real-time UI updates.

### [](#instant-user-messages)Instant User Messages
...
### [](#full-streaming-implementation)Full Streaming Implementation
...
### [](#message-ordering-issues)Message Ordering Issues

Action Cable processes messages concurrently, which can cause out-of-order delivery:

#### [](#solution-1-client-side-reordering-recommended)Solution 1: Client-Side Reordering (Recommended)
...
#### [](#solution-2-server-side-ordering)Solution 2: Server-Side Ordering
...
#### [](#namespaced-models-example)Namespaced Models Example
...
- [Chatting with AI Models](https://rubyllm.com/chat/)
- [Using Tools](https://rubyllm.com/tools/)
- [Streaming Responses](https://rubyllm.com/streaming/)
- [Working with Models](https://rubyllm.com/models/)
- [Error Handling](https://rubyllm.com/error-handling/)
